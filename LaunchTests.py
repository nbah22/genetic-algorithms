...
if __name__ == '__main__':
    ...
    p = Tests.Population(size=25, params=params, params_range=params_range, log_file='log_1.txt',
                         averages_log='avg_log_1.txt', settings_file='Tests_settings.txt', load=False)
